...
public class BlackBishop extends ChessPiece {
    ...
    private int moveToY;
    BlackBishop() {
        super(new ImageIcon("bbishop.png"), 0);
    }
    ...
    //condition is
    //where xMove is defined as this.posX - posX 
    //and yMove is defined as this.posY - posY
    //and absolutevalue of YMove must be equalto XMove
    //xMove + yMove must be even number
    //
    @Override
